...
class _UsernamePromptScreenState extends State<UsernamePromptScreen> {
  ...
  _navigateToHome() async {
    ...
    await prefs.setString('lesson4', "Not Finished");
    await prefs.setString('lesson5', "Not Finished");
    await prefs.setString('lesson6', "Not Finished");
    await prefs.setString('lesson7', "Not Finished");
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'We will use it to refer to you',
